...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        while (it.hasNext()) {
            String s = it.next();
            boolean iguales = (cadena == null ? s == null : (s != null && s.equalsIgnoreCase(cadena)));
            if (iguales) it.remove();
        }
    }
    ...
    public void volverMayusculas( )
    {
        ...
        for (String s : arbolCadenas) {
            if (s != null) nuevo.add(s.toUpperCase());
        }
        arbolCadenas = nuevo;
    }
    ...
    {
        TreeSet<String> inverso = new TreeSet<String>(Collections.reverseOrder());
        inverso.addAll(arbolCadenas);
        return inverso;
    }
